...
pytestmark = [pytest.mark.integration, pytest.mark.skip(reason="HLDS mod maps not available via SteamCMD (vs_frost not found)")]
...
def test_vsserver_lifecycle(tmp_path):
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "vsserver")
