...
pytestmark = [pytest.mark.integration, pytest.mark.skip(
    reason="SteamCMD app 3809400 is Windows-only (StarRuptureServerEOS.exe)"
)]
START_TIMEOUT = 300
STOP_TIMEOUT = 90
...
def test_starruptureserver_lifecycle(tmp_path):
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "starruptureserver")
