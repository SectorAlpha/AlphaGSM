...
defaults to GHCR tags such as
`ghcr.io/sectoralpha/alphagsm-java-runtime:2026-04`, while the Dockerfiles live
here so image contents are versioned alongside the code.
