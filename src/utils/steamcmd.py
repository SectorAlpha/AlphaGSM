...
STEAMCMD_DIR = os.path.expanduser(_CONFIGURED_STEAMCMD_DIR or _DEFAULT_STEAMCMD_DIR)
...
_KNOWN_BARE_STATE_202_FLAKE_APP_IDS = frozenset(
    {"232130", "294420", "346680", "418480", "746200"}
)
