...
command_args = gamemodule_common.build_setup_update_restart_command_args(
    ...
    "The directory to install DayZ Arma 2 Epoch in",
)
command_descriptions = gamemodule_common.build_update_restart_command_descriptions(
    "Update the DayZ Arma 2 Epoch dedicated server to the latest version.",
    "Restart the DayZ Arma 2 Epoch dedicated server.",
)
command_functions = {}
max_stop_wait = 1
...
def configure(server, ask, port=None, dir=None, *, exe_name="arma2oaserver"):
    ...
    gamemodule_common.ensure_backup_config(
        server,
        backupfiles=["mpmissions", "profiles", "server.cfg", "@DayZ_Epoch"],
        targets=["mpmissions", "profiles", "server.cfg", "@DayZ_Epoch"],
    )
    ...
    gamemodule_common.configure_install_dir(
        ...
        ask,
        dir,
        prompt="Where would you like to install the DayZ Arma 2 Epoch server:",
    )
