"""Half-Life 2: Deathmatch-specific lifecycle, configuration, and update helpers."""
...
MOD_SUPPORT = build_source_addon_mod_support(
    game_label="Half-Life 2: Deathmatch",
    game_dir="hl2mp",
    cache_namespace="hl2dmserver",
    direct_url_suffixes={},
