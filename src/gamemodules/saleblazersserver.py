...
def install(server):
    """Download the Saleblazers server files via SteamCMD."""
...
def update(server, validate=False, restart=False):
    """Update the Saleblazers server files and optionally restart the server."""
...
def restart(server):
    """Restart the Saleblazers server."""
...
def status(server, verbose):
    """Detailed Saleblazers status is not implemented yet."""
