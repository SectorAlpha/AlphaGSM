"""Pirates Vikings & Knights II-specific lifecycle, configuration, and update helpers."""
...
MODULE = define_valve_server_module(
    game_name='Pirates Vikings & Knights II',
    engine='source',
    steam_app_id=17575,
    game_dir='pvkii',
    executable='srcds_run',
    default_map='bt_island',
    max_players=24,
    port=27015,
    client_port=27005,
    sourcetv_port=27020,
...
MOD_SUPPORT = build_source_addon_mod_support(
        game_label='Pirates Vikings & Knights II',
        game_dir='pvkii',
        cache_namespace='pvkii',
        direct_url_suffixes={},
