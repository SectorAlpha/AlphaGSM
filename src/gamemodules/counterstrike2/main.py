...
command_args["mod"] = CmdSpec(
    ...
    optionalarguments=(
        ArgSpec("SOURCE", "gamebanana, moddb, or workshop", str),
        ArgSpec("IDENTIFIER", "provider item id or Mod DB page URL", str),
...
command_descriptions["mod"] = "Manage CS2 server-side mods from external GameBanana, Mod DB, or workshop sources."
command_functions = {}
max_stop_wait = 1
...
MOD_SUPPORT = build_source_addon_mod_support(
    ...
    enabled_sources=("gamebanana", "moddb", "workshop"),
    extra_payload_roots=("csgo",),
    ...
    workshop_app_id=CS2_WORKSHOP_APP_ID,
...
cs2_mod_command = MOD_SUPPORT.command_functions["mod"]
