...
command_descriptions = {
    "update": "Update the Brickadia dedicated server to the latest version.",
    "restart": "Restart the Brickadia dedicated server.",
}
command_functions = {}
max_stop_wait = 1
...
def checkvalue(server, key, *value):
    ...
    if key[0] in ("port", "queryport"):
        return int(value[0])
    if key[0] in ("exe_name", "dir", "servername"):
        return str(value[0])
