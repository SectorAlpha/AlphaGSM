...
def install(server):
    """Download the ETS2 server files via SteamCMD."""
...
def update(server, validate=False, restart=False):
    """Update the ETS2 server files and optionally restart the server."""
...
def status(server, verbose):
    """Detailed ETS2 status is not implemented yet."""
