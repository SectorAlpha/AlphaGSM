...
command_descriptions = {
    "update": "Update the Exfil dedicated server to the latest version.",
    "restart": "Restart the Exfil dedicated server.",
}
command_functions = {}
max_stop_wait = 1
...
def install(server):
    """Download the Exfil server files via SteamCMD."""
...
def update(server, validate=False, restart=False):
    """Update the Exfil server files and optionally restart the server."""
