"""Empires Mod-specific lifecycle, configuration, and update helpers."""
...
MODULE = define_valve_server_module(
    game_name='Empires Mod',
    engine='source',
    steam_app_id=460040,
    game_dir='empires',
    executable='srcds_run',
    default_map='con_district402',
    max_players=62,
    port=27015,
    client_port=27005,
    sourcetv_port=27020,
...
MOD_SUPPORT = build_source_addon_mod_support(
        game_label='Empires Mod',
        game_dir='empires',
        cache_namespace='empires',
        direct_url_suffixes={},
