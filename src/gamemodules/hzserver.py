...
command_descriptions = {
    "update": "Update the Humanitz dedicated server to the latest version.",
    "restart": "Restart the Humanitz dedicated server.",
}
command_functions = {}
max_stop_wait = 1
...
def install(server):
    """Download the Humanitz server files via SteamCMD."""
...
def update(server, validate=False, restart=False):
    """Update the Humanitz server files and optionally restart the server."""
