"""Black Mesa: Deathmatch-specific lifecycle, configuration, and update helpers."""
...
MODULE = define_valve_server_module(
    game_name='Black Mesa: Deathmatch',
    engine='source',
    steam_app_id=346680,
    game_dir='bms',
    executable='srcds_run',
    default_map='dm_bounce',
    max_players=16,
    port=27015,
    client_port=27005,
    sourcetv_port=27020,
...
MOD_SUPPORT = build_source_addon_mod_support(
        game_label='Black Mesa: Deathmatch',
        game_dir='bms',
        cache_namespace='bms',
        direct_url_suffixes={},
