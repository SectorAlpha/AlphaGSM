...
def install(server):
    """Download the Icarus server files via SteamCMD."""
...
def update(server, validate=False, restart=False):
    """Update the Icarus server files and optionally restart the server."""
...
def status(server, verbose):
    """Detailed Icarus status is not implemented yet."""
