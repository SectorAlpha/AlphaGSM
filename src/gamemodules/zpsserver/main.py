"""Zombie Panic! Source-specific lifecycle, configuration, and update helpers."""
...
MODULE = define_valve_server_module(
    game_name='Zombie Panic! Source',
    engine='source',
    steam_app_id=17505,
    game_dir='zps',
    executable='srcds_run',
    default_map='zps_deadend',
    max_players=20,
    port=27015,
    client_port=27005,
    sourcetv_port=27020,
...
MOD_SUPPORT = build_source_addon_mod_support(
        game_label='Zombie Panic! Source',
        game_dir='zps',
        cache_namespace='zps',
        direct_url_suffixes={},
