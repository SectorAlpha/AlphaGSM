"""Half-Life Deathmatch: Source-specific lifecycle, configuration, and update helpers."""
...
MODULE = define_valve_server_module(
    game_name='Half-Life Deathmatch: Source',
    engine='source',
    steam_app_id=255470,
    game_dir='hl1mp',
    executable='srcds_run',
    default_map='crossfire',
    max_players=16,
    port=27015,
    client_port=27005,
    sourcetv_port=27020,
...
MOD_SUPPORT = build_source_addon_mod_support(
        game_label='Half-Life Deathmatch: Source',
        game_dir='hl1mp',
        cache_namespace='hl1mp',
        direct_url_suffixes={},
