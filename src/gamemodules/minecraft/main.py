"""Grouped Minecraft game modules.

This package defaults to the vanilla Minecraft server module while also
exposing the existing Minecraft variants under a namespaced layout.
"""
