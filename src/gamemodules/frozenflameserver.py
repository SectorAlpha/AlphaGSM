...
command_args = gamemodule_common.build_setup_update_restart_command_args(
    "The game port to use for the Frozen Flame server",
    "The directory to install Frozen Flame in",
)
...
def configure(server, ask, port=None, dir=None, *, exe_name="FrozenFlameServer.sh"):
    ...
    gamemodule_common.configure_install_dir(
        ...
        ask,
        dir,
        prompt="Where would you like to install the Frozen Flame server:",
    )
