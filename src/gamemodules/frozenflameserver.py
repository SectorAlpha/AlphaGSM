...
command_descriptions = {
    "update": "Update the Frozen Flame dedicated server to the latest version.",
    "restart": "Restart the Frozen Flame dedicated server.",
}
command_functions = {}
max_stop_wait = 1
...
def install(server):
    """Download the Frozen Flame server files via SteamCMD."""
...
def update(server, validate=False, restart=False):
    """Update the Frozen Flame server files and optionally restart the server."""
...
def restart(server):
    """Restart the Frozen Flame server."""
