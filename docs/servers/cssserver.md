...
After `create cssserver`, inspect or change these with `set`:
...
| `servername` | hostname, name | string | The server's public name shown to players. Example: `AlphaGSM Counter-Strike: Source`. |
