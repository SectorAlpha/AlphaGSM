"""Full coverage tests for frozenflameserver."""
...
sys.modules.pop('gamemodules.frozenflameserver', None)
with patch.dict('sys.modules', {'screen': MagicMock(), 'utils.backups': MagicMock(), 'utils.backups.backups': MagicMock(), 'utils.steamcmd': MagicMock()}):
    import gamemodules.frozenflameserver as mod
...
def test_install(tmp_path):
    ...
    server.data["Steam_AppID"] = 1348640
...
def test_setting_schema_exposes_frozenflame_launch_formats():
