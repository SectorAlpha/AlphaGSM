"""Full coverage tests for btlserver."""
...
def test_install(tmp_path):
    server = DummyServer()
    server.data["dir"] = str(tmp_path) + "/"
    server.data["exe_name"] = "Battalion/Binaries/Linux/BattalionServer-Linux-Shipping"
    server.data["Steam_AppID"] = 805140
...
def test_get_start_command(tmp_path):
    ...
    server.data["dir"] = str(tmp_path) + "/"
    server.data["exe_name"] = "Battalion/Binaries/Linux/BattalionServer-Linux-Shipping"
    exe_path = tmp_path / "Battalion/Binaries/Linux/BattalionServer-Linux-Shipping"
