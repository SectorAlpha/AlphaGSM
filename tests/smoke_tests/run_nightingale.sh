...
echo "Smoke test for nightingale is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itnightingal}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/nightingale-server"
CONFIG_PATH="$WORK_DIR/alphagsm-nightingale.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-nightingal-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-nightingal-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create nightingale
