...
echo "Smoke test for pcarserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itpcarserver}"
SERVER_STARTED=0
...
LOG_PATH="$HOME_DIR/logs/AlphaGSM-pcarserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-pcarserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create pcarserver
