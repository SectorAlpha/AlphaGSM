...
INSTALL_DIR="$WORK_DIR/arma3-wasteland-server"
CONFIG_PATH="$WORK_DIR/alphagsm-arma3-wasteland.conf"
...
run_create_or_skip_disabled "$SERVER_NAME" create arma3.wasteland
