...
SERVER_NAME="${SERVER_NAME:-ittfcserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/tfcserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-tfcserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-tfcserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-tfcserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create tfcserver
