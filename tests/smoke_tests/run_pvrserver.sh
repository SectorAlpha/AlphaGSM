...
echo "Smoke test for pvrserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itpvrserver}"
SERVER_STARTED=0
...
LOG_PATH="$HOME_DIR/logs/AlphaGSM-pvrserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-pvrserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create pvrserver
