...
echo "Smoke test for hogwarpserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-ithogwarpser}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/hogwarpserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-hogwarpserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-hogwarpser-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-hogwarpser-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create hogwarpserver
