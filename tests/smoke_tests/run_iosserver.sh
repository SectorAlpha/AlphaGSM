...
SERVER_NAME="${SERVER_NAME:-itiosserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/iosserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-iosserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-iosserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-iosserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create iosserver
