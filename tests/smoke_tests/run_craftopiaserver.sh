...
echo "Smoke test for craftopiaserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itcraftopias}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/craftopiaserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-craftopiaserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-craftopias-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-craftopias-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create craftopiaserver
