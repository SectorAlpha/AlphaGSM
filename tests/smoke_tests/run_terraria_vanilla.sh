...
SERVER_NAME="${SERVER_NAME:-itterrariava}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/terraria-vanilla-server"
CONFIG_PATH="$WORK_DIR/alphagsm-terraria-vanilla.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-terrariava-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-terrariava-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create terraria.vanilla
