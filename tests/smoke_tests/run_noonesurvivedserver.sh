...
echo "Smoke test for noonesurvivedserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
CONFIG_PATH="$WORK_DIR/alphagsm-noonesurvivedserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-noonesurvi-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-noonesurvi-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create noonesurvivedserver
