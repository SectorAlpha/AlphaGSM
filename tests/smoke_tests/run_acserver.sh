...
SERVER_NAME="${SERVER_NAME:-itacserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/acserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-acserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-acserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-acserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create acserver
