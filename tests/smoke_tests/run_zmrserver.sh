...
SERVER_NAME="${SERVER_NAME:-itzmrserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/zmrserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-zmrserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-zmrserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-zmrserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create zmrserver
