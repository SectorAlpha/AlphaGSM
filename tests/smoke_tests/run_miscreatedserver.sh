...
echo "Smoke test for miscreatedserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itmiscreated}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/miscreatedserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-miscreatedserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-miscreated-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-miscreated-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create miscreatedserver
