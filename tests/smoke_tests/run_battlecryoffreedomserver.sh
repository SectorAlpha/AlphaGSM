...
echo "Smoke test for battlecryoffreedomserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itbattlecryo}"
SERVER_STARTED=0
...
sessiontag = AlphaGSM-battlecryo-IT#
keeplogs = 1
EOF
...
run_alphagsm "$SERVER_NAME" create battlecryoffreedomserver
