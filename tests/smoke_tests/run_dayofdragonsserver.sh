...
SERVER_NAME="${SERVER_NAME:-itdayofdrago}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/dayofdragonsserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-dayofdragonsserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-dayofdrago-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-dayofdrago-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create dayofdragonsserver
