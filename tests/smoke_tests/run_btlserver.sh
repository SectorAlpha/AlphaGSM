...
SERVER_NAME="${SERVER_NAME:-itbtlserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/btlserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-btlserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-btlserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-btlserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create btlserver
