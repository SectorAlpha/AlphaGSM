...
echo "Smoke test for cryofallserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itcryofallse}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/cryofallserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-cryofallserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-cryofallse-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-cryofallse-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create cryofallserver
