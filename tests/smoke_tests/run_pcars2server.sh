...
echo "Smoke test for pcars2server is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itpcars2serv}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/pcars2server-server"
CONFIG_PATH="$WORK_DIR/alphagsm-pcars2server.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-pcars2serv-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-pcars2serv-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create pcars2server
