...
echo "Smoke test for terratechworldsserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itterratechw}"
SERVER_STARTED=0
...
LOG_PATH="$HOME_DIR/logs/AlphaGSM-terratechw-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-terratechw-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create terratechworldsserver
