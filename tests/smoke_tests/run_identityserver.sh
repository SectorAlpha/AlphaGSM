...
SERVER_NAME="${SERVER_NAME:-itidentityse}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/identityserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-identityserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-identityse-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-identityse-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create identityserver
