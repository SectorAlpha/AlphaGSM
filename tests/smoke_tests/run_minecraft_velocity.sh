...
SERVER_NAME="${SERVER_NAME:-itminecraftv}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/minecraft-velocity-server"
CONFIG_PATH="$WORK_DIR/alphagsm-minecraft-velocity.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-minecraftv-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-minecraftv-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create minecraft.velocity
