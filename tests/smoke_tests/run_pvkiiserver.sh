...
SERVER_NAME="${SERVER_NAME:-itpvkiiserve}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/pvkiiserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-pvkiiserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-pvkiiserve-IT#$SERVER_NAME.log"
...
run_create_or_skip_disabled "$SERVER_NAME" create pvkiiserver
