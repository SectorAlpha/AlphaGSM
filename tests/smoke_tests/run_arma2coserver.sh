...
echo "Smoke test for arma2coserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itarma2coser}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/arma2coserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-arma2coserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-arma2coser-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-arma2coser-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create arma2coserver
