#!/usr/bin/env bash
# Smoke test: Minecraft Vanilla lifecycle via the subprocess backend.
set -Eeuo pipefail
set -x
...
SERVER_NAME="${SERVER_NAME:-bk-subproc}"
...
require_cmd java
# No screen or tmux needed — subprocess backend is pure Python.
