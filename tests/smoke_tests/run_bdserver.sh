...
SERVER_NAME="${SERVER_NAME:-itbdserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/bdserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-bdserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-bdserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-bdserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create bdserver
