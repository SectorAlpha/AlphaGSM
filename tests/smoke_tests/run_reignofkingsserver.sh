...
SERVER_NAME="${SERVER_NAME:-itreignofkin}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/reignofkingsserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-reignofkingsserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-reignofkin-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-reignofkin-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create reignofkingsserver
