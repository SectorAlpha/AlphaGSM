...
echo "Smoke test for warbandserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itwarbandser}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/warbandserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-warbandserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-warbandser-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-warbandser-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create warbandserver
