...
echo "Smoke test for armarserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itarmarserve}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/armarserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-armarserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-armarserve-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-armarserve-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create armarserver
