...
SERVER_NAME="${SERVER_NAME:-itmemoriesof}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/memoriesofmarsserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-memoriesofmarsserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-memoriesof-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-memoriesof-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create memoriesofmarsserver
