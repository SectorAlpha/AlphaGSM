...
SERVER_NAME="${SERVER_NAME:-itgoldeneyes}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/goldeneyesourceserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-goldeneyesourceserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-goldeneyes-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-goldeneyes-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create goldeneyesourceserver
