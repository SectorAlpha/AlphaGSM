...
SERVER_NAME="${SERVER_NAME:-itrimworldto}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/rimworldtogetherserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-rimworldtogetherserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-rimworldto-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-rimworldto-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create rimworldtogetherserver
