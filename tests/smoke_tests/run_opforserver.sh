...
SERVER_NAME="${SERVER_NAME:-itopforserve}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/opforserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-opforserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-opforserve-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-opforserve-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create opforserver
