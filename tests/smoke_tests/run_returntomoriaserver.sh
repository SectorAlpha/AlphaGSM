...
SERVER_NAME="${SERVER_NAME:-itreturntomo}"
SERVER_STARTED=0
...
LOG_PATH="$HOME_DIR/logs/AlphaGSM-returntomo-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-returntomo-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create returntomoriaserver
