...
INSTALL_DIR="$WORK_DIR/insserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-insserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-insserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-insserver-IT#
keeplogs = 1

# Keep the smoke server awake for real A2S query and info checks.
[gamemodules.insserver.servercfg]
...
run_create_or_skip_disabled "$SERVER_NAME" create insserver
