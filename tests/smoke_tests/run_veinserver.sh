...
echo "Smoke test for veinserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itveinserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/veinserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-veinserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-veinserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-veinserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create veinserver
