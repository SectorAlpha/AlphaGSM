...
SERVER_NAME="${SERVER_NAME:-itahlserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/ahlserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-ahlserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-ahlserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-ahlserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create ahlserver
