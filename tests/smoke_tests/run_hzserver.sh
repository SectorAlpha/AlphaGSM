...
echo "Smoke test for hzserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-ithzserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/hzserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-hzserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-hzserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-hzserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create hzserver
