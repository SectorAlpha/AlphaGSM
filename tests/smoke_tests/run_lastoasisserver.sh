...
echo "Smoke test for lastoasisserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itlastoasiss}"
SERVER_STARTED=0
...
CONFIG_PATH="$WORK_DIR/alphagsm-lastoasisserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-lastoasiss-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-lastoasiss-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create lastoasisserver
