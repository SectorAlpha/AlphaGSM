...
SERVER_NAME="${SERVER_NAME:-itmordserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/mordserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-mordserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-mordserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-mordserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create mordserver
