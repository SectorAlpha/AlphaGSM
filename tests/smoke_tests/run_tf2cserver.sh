...
SERVER_NAME="${SERVER_NAME:-ittf2cserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/tf2cserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-tf2cserver.conf"
...
run_create_or_skip_disabled "$SERVER_NAME" create tf2cserver
