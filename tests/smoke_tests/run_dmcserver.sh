...
SERVER_NAME="${SERVER_NAME:-itdmcserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/dmcserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-dmcserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-dmcserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-dmcserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create dmcserver
