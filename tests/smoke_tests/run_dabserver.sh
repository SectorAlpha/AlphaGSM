...
SERVER_NAME="${SERVER_NAME:-itdabserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/dabserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-dabserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-dabserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-dabserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create dabserver
