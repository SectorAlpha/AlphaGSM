...
SERVER_NAME="${SERVER_NAME:-itatsserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/atsserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-atsserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-atsserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-atsserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create atsserver
