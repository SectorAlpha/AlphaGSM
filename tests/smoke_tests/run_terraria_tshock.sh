...
echo "Smoke test for terraria_tshock is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itterrariats}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/terraria-tshock-server"
CONFIG_PATH="$WORK_DIR/alphagsm-terraria-tshock.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-terrariats-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-terrariats-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create terraria.tshock
