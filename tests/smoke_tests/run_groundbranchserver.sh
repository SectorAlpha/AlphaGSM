...
echo "Smoke test for groundbranchserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
LOG_PATH="$HOME_DIR/logs/AlphaGSM-groundbran-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-groundbran-IT#
keeplogs = 1
EOF
...
run_alphagsm "$SERVER_NAME" create groundbranchserver
