...
SERVER_NAME="${SERVER_NAME:-itricochetse}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/ricochetserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-ricochetserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-ricochetse-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-ricochetse-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create ricochetserver
