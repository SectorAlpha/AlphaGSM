...
SERVER_NAME="${SERVER_NAME:-itccserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/ccserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-ccserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-ccserver-IT#$SERVER_NAME.log"
...
run_create_or_skip_disabled "$SERVER_NAME" create ccserver
