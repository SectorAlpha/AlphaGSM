...
echo "Smoke test for hurtworldserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-ithurtworlds}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/hurtworldserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-hurtworldserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-hurtworlds-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-hurtworlds-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create hurtworldserver
