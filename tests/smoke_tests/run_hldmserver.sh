...
SERVER_NAME="${SERVER_NAME:-ithldmserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/hldmserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-hldmserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-hldmserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-hldmserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create hldmserver
