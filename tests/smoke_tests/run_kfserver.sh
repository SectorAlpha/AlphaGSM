...
SERVER_NAME="${SERVER_NAME:-itkfserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/kfserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-kfserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-kfserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-kfserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create kfserver
