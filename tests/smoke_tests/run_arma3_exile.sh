...
echo "Smoke test for arma3_exile is ENABLED (AUTH) - authenticate Steam or SteamCMD with an account entitled to Arma 3 dedicated server app 233780 before setup/start."
exit 77
...
INSTALL_DIR="$WORK_DIR/arma3-exile-server"
CONFIG_PATH="$WORK_DIR/alphagsm-arma3-exile.conf"
...
run_create_or_skip_disabled "$SERVER_NAME" create arma3.exile
