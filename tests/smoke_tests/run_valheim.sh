...
SERVER_NAME="${SERVER_NAME:-itvalheim}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/valheim-server"
CONFIG_PATH="$WORK_DIR/alphagsm-valheim.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-valheim-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-valheim-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create valheim
