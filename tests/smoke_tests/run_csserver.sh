...
SERVER_NAME="${SERVER_NAME:-itcsserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/csserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-csserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-csserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-csserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create csserver
