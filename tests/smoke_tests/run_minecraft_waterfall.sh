...
SERVER_NAME="${SERVER_NAME:-itminecraftw}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/minecraft-waterfall-server"
CONFIG_PATH="$WORK_DIR/alphagsm-minecraft-waterfall.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-minecraftw-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-minecraftw-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create minecraft.waterfall
