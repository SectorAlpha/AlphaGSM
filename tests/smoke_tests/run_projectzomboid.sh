...
SERVER_NAME="${SERVER_NAME:-itprojectzom}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/projectzomboid-server"
CONFIG_PATH="$WORK_DIR/alphagsm-projectzomboid.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-projectzom-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-projectzom-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create projectzomboid
