...
SERVER_NAME="${SERVER_NAME:-itsatisfacto}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/satisfactory-server"
CONFIG_PATH="$WORK_DIR/alphagsm-satisfactory.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-satisfacto-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-satisfacto-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create satisfactory
