...
SERVER_NAME="${SERVER_NAME:-itns2server}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/ns2server-server"
CONFIG_PATH="$WORK_DIR/alphagsm-ns2server.conf"
...
run_create_or_skip_disabled "$SERVER_NAME" create ns2server
