...
SERVER_NAME="${SERVER_NAME:-itsubnautica}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/subnauticaserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-subnauticaserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-subnautica-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-subnautica-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create subnauticaserver
