...
SERVER_NAME="${SERVER_NAME:-itmumbleserv}"
SERVER_STARTED=0
DOCKER_IMAGE="${ALPHAGSM_BACKEND_DOCKER_IMAGE_SIMPLE_TCP:-ghcr.io/sectoralpha/alphagsm-simple-tcp-runtime:latest}"
...
INSTALL_DIR="$WORK_DIR/mumbleserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-mumbleserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-mumbleserv-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-mumbleserv-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create mumbleserver
