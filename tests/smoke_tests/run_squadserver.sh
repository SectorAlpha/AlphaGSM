...
SERVER_NAME="${SERVER_NAME:-itsquadserve}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/squadserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-squadserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-squadserve-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-squadserve-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create squadserver
