...
echo "Smoke test for wurmserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itwurmserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/wurmserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-wurmserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-wurmserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-wurmserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create wurmserver
