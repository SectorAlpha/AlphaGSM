...
echo "Smoke test for medievalengineersserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itmedievalen}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/medievalengineersserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-medievalengineersserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-medievalen-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-medievalen-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create medievalengineersserver
