...
echo "Smoke test for vintagestoryserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itvintagesto}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/vintagestoryserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-vintagestoryserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-vintagesto-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-vintagesto-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create vintagestoryserver
