...
SERVER_NAME="${SERVER_NAME:-itfrozenflam}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/frozenflameserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-frozenflameserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-frozenflam-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-frozenflam-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create frozenflameserver
