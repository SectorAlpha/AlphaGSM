...
echo "Smoke test for wreckfestserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itwreckfests}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/wreckfestserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-wreckfestserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-wreckfests-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-wreckfests-IT#
keeplogs = 1
EOF
