...
echo "Smoke test for scpslserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itscpslserve}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/scpslserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-scpslserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-scpslserve-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-scpslserve-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create scpslserver
