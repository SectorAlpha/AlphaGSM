...
SERVER_NAME="${SERVER_NAME:-itredmserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/redmserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-redmserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-redmserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-redmserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create redmserver
