...
SERVER_NAME="${SERVER_NAME:-itsquad44ser}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/squad44server-server"
CONFIG_PATH="$WORK_DIR/alphagsm-squad44server.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-squad44ser-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-squad44ser-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create squad44server
