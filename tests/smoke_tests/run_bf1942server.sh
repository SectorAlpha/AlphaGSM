...
SERVER_NAME="${SERVER_NAME:-itbf1942serv}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/bf1942server-server"
CONFIG_PATH="$WORK_DIR/alphagsm-bf1942server.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-bf1942serv-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-bf1942serv-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create bf1942server
