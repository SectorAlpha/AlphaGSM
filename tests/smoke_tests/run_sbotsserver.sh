...
SERVER_NAME="${SERVER_NAME:-itsbotsserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/sbotsserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-sbotsserver.conf"
...
run_create_or_skip_disabled "$SERVER_NAME" create sbotsserver
