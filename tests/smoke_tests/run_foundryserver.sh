...
SERVER_NAME="${SERVER_NAME:-itfoundryser}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/foundryserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-foundryserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-foundryser-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-foundryser-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create foundryserver
