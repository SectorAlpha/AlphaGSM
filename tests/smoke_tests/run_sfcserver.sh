...
SERVER_NAME="${SERVER_NAME:-itsfcserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/sfcserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-sfcserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-sfcserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-sfcserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create sfcserver
