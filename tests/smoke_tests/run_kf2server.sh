...
SERVER_NAME="${SERVER_NAME:-itkf2server}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/kf2server-server"
CONFIG_PATH="$WORK_DIR/alphagsm-kf2server.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-kf2server-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-kf2server-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create kf2server
