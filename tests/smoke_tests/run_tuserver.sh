...
SERVER_NAME="${SERVER_NAME:-ittuserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/tuserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-tuserver.conf"
...
run_create_or_skip_disabled "$SERVER_NAME" create tuserver
