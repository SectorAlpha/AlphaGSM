...
SERVER_NAME="${SERVER_NAME:-itstnserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/stnserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-stnserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-stnserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-stnserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create stnserver
