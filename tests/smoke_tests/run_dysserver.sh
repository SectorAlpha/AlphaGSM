...
SERVER_NAME="${SERVER_NAME:-itdysserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/dysserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-dysserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-dysserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-dysserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create dysserver
