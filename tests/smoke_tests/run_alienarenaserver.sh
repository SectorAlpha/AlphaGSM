...
echo "Smoke test for alienarenaserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-italienarena}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/alienarenaserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-alienarenaserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-alienarena-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-alienarena-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create alienarenaserver
