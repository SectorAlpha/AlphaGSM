...
SERVER_NAME="${SERVER_NAME:-itminecraftp}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/minecraft-paper-server"
CONFIG_PATH="$WORK_DIR/alphagsm-minecraft-paper.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-minecraftp-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-minecraftp-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create minecraft.paper
run_setup_or_skip_steamcmd "$SERVER_NAME" setup -n -l "$PORT" "$INSTALL_DIR"
