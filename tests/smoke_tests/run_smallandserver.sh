...
echo "Smoke test for smallandserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itsmallandse}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/smallandserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-smallandserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-smallandse-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-smallandse-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create smallandserver
