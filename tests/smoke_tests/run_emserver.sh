...
SERVER_NAME="${SERVER_NAME:-itemserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/emserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-emserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-emserver-IT#$SERVER_NAME.log"
...
run_create_or_skip_disabled "$SERVER_NAME" create emserver
