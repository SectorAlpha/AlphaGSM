...
SERVER_NAME="${SERVER_NAME:-itreignofdwa}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/reignofdwarfserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-reignofdwarfserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-reignofdwa-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-reignofdwa-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create reignofdwarfserver
