...
SERVER_NAME="${SERVER_NAME:-itrtcwserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/rtcwserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-rtcwserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-rtcwserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-rtcwserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create rtcwserver
