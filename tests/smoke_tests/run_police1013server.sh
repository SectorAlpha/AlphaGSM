...
SERVER_NAME="${SERVER_NAME:-itpolice1013}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/police1013server-server"
CONFIG_PATH="$WORK_DIR/alphagsm-police1013server.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-police1013-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-police1013-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create police1013server
