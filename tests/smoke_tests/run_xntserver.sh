...
CONFIG_PATH="$WORK_DIR/alphagsm-xntserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-xntserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-xntserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create xntserver
