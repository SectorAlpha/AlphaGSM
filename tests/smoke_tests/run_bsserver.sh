...
SERVER_NAME="${SERVER_NAME:-itbsserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/bsserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-bsserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-bsserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-bsserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create bsserver
