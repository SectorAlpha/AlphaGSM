...
SERVER_NAME="${SERVER_NAME:-itstormworks}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/stormworksserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-stormworksserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-stormworks-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-stormworks-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create stormworksserver
