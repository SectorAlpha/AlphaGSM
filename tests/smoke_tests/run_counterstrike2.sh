...
SERVER_NAME="${SERVER_NAME:-itcounterstrike2}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/counterstrike2-server"
CONFIG_PATH="$WORK_DIR/alphagsm-counterstrike2.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-counterstrike2-IT#$SERVER_NAME.log"
