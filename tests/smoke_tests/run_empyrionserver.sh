...
echo "Smoke test for empyrionserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
sessiontag = AlphaGSM-empyrionse-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create empyrionserver
