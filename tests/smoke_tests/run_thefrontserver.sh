...
SERVER_NAME="${SERVER_NAME:-itthefrontse}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/thefrontserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-thefrontserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-thefrontse-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-thefrontse-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create thefrontserver
