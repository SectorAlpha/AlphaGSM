...
SERVER_NAME="${SERVER_NAME:-itdodserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/dodserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-dodserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-dodserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-dodserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create dodserver
