...
echo "Smoke test for deadpolyserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itdeadpolyse}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/deadpolyserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-deadpolyserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-deadpolyse-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-deadpolyse-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create deadpolyserver
