...
SERVER_NAME="${SERVER_NAME:-itaccserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/accserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-accserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-accserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-accserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create accserver
