...
echo "Smoke test for etlegacyserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itetlegacyse}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/etlegacyserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-etlegacyserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-etlegacyse-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-etlegacyse-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create etlegacyserver
