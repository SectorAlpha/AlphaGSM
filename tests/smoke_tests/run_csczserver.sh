...
SERVER_NAME="${SERVER_NAME:-itcsczserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/csczserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-csczserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-csczserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-csczserver-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create csczserver
