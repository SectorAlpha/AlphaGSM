...
echo "Smoke test for trackmaniaserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-ittrackmania}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/trackmaniaserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-trackmaniaserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-trackmania-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-trackmania-IT#
keeplogs = 1
EOF
...
run_create_or_skip_disabled "$SERVER_NAME" create trackmaniaserver
