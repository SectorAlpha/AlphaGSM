...
pytestmark = [pytest.mark.integration, pytest.mark.skip(reason="HLDS mod maps not available via SteamCMD (ts_neobaroque not found)")]
...
def test_tsserver_lifecycle(tmp_path):
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "tsserver")
