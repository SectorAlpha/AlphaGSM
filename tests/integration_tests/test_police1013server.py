"""Integration test for police1013server."""

import pytest

from conftest import (
from gamemodules.police1013server import steam_app_id
...
def test_police1013server_lifecycle(tmp_path):
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "police1013server")
