"""Integration test for ror2server."""
...
from gamemodules.ror2server import steam_app_id

pytestmark = [
    pytest.mark.integration,
    pytest.mark.skip(
        reason="ENABLED (AUTH): authenticate Steam or SteamCMD with an account entitled to Risk of Rain 2 dedicated server app 1180760 before setup/start"
    ),
]
START_TIMEOUT = 600
STOP_TIMEOUT = 90
...
def test_ror2server_lifecycle(tmp_path):
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "ror2server")
