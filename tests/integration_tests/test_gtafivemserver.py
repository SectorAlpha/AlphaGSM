"""Integration test for gtafivemserver.

ENABLED (BYO): FiveM requires operator-managed txAdmin/server-data provisioning.
"""
...
def test_gtafivemserver_lifecycle(tmp_path):
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "gtafivemserver")
