...
def test_q4server_lifecycle(tmp_path):
    require_integration_opt_in()
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "q4server")
    ...
    try:
        ...
        # Quake 4 uses the Quake UDP status protocol, not A2S
