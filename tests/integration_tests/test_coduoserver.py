"""Integration test for coduoserver."""
...
def test_coduoserver_lifecycle(tmp_path):
    require_integration_opt_in()
    ...
    write_config(
        ...
        module_name="coduoserver",
    )
    env = alphagsm_env(config_path)
    port = pick_free_tcp_port()

    # create
    run_and_assert_ok(env, server_name, "create", "coduoserver")
