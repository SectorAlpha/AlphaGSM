"""Integration test for dodserver."""
...
def test_dodserver_lifecycle(tmp_path):
    require_integration_opt_in()
    require_steamcmd_opt_in()
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "dodserver")
    ...
    assert result.returncode == 0, (
        f"Unexpected dodserver setup failure: rc={result.returncode}\n"
