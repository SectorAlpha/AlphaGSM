"""Integration test for opforserver."""
...
from gamemodules.opforserver import steam_app_id
...
def test_opforserver_lifecycle(tmp_path):
    require_integration_opt_in()
    require_steamcmd_opt_in()
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "opforserver")
    ...
    assert result.returncode == 0, (
        f"Unexpected opforserver setup failure: rc={result.returncode}\n"
