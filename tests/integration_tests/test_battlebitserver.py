"""Integration test for battlebitserver."""

import pytest

from conftest import (
from gamemodules.battlebitserver import steam_app_id
...
def test_battlebitserver_lifecycle(tmp_path):
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "battlebitserver")
