"""Integration test for dmcserver."""
...
from gamemodules.dmcserver import steam_app_id
...
def test_dmcserver_lifecycle(tmp_path):
    require_integration_opt_in()
    require_steamcmd_opt_in()
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "dmcserver")
    ...
    assert result.returncode == 0, (
        f"Unexpected dmcserver setup failure: rc={result.returncode}\n"
