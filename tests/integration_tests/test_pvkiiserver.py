"""Integration test for pvkiiserver."""
...
from gamemodules.pvkiiserver import steam_app_id
...
def test_pvkiiserver_lifecycle(tmp_path):
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "pvkiiserver")
