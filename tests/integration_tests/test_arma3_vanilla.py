"""Integration test for arma3.vanilla.
...
from gamemodules.arma3server import steam_app_id
...
def test_arma3_vanilla_lifecycle(tmp_path):
    require_integration_opt_in()
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "arma3.vanilla")
