"""Integration test for satisfactory."""
...
from gamemodules.satisfactory import steam_app_id
...
def test_satisfactory_lifecycle(tmp_path):
    require_integration_opt_in()
    require_steamcmd_opt_in()
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "satisfactory")
    ...
    try:
        ...
        # In headless CI the dedicated A2S query port is not reliable, but the
        # game port consistently opens and the server core falls back to TCP.
