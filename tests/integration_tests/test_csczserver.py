"""Integration test for csczserver."""
...
from gamemodules.csczserver import steam_app_id
...
def test_csczserver_lifecycle(tmp_path):
    require_integration_opt_in()
    require_steamcmd_opt_in()
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "csczserver")
    ...
    assert result.returncode == 0, (
        f"Unexpected csczserver setup failure: rc={result.returncode}\n"
