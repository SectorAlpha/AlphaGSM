...
pytestmark = [
    ...
    pytest.mark.skip(reason="LunaMultiplayer release is Windows-only (PE32+ .exe)"),
]
...
def test_kerbalspaceprogramserver_lifecycle(tmp_path):
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "kerbalspaceprogramserver")
