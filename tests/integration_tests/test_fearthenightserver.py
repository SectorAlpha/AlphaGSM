"""Integration test for fearthenightserver."""
...
from gamemodules.fearthenightserver import steam_app_id
...
def test_fearthenightserver_lifecycle(tmp_path):
    require_integration_opt_in()
    require_steamcmd_opt_in()
    require_proton()
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "fearthenightserver")
    run_and_assert_ok(env, server_name, "set", "queryport", str(queryport))
    run_and_assert_ok(env, server_name, "set", "servername", server_name)
