"""Integration test for inssserver."""
...
from gamemodules.inssserver import steam_app_id
...
def test_inssserver_lifecycle(tmp_path):
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "inssserver")
    ...
    try:
        ...
        # Insurgency: Sandstorm exposes A2S on queryport (game port + 1), not the game port
