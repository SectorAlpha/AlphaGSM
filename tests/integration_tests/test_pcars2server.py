"""Integration test for pcars2server."""

import pytest

from conftest import (
from gamemodules.pcars2server import steam_app_id
...
def test_pcars2server_lifecycle(tmp_path):
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "pcars2server")
