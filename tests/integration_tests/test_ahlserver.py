...
pytestmark = [pytest.mark.integration, pytest.mark.skip(reason="HLDS mod maps not available via SteamCMD (ahl_hydro not found)")]
...
def test_ahlserver_lifecycle(tmp_path):
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "ahlserver")
