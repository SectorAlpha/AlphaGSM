...
from gamemodules.tiserver import steam_app_id
...
@pytest.mark.skip(reason="SteamCMD app 412680 installs no Linux-compatible dedicated server binary (executable file not found)")
