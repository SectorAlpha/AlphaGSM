"""Integration test for veinserver."""
...
from gamemodules.veinserver import steam_app_id
...
def test_veinserver_lifecycle(tmp_path):
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "veinserver")
