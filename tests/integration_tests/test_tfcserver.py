"""Integration test for tfcserver."""
...
from gamemodules.tfcserver import steam_app_id
...
def test_tfcserver_lifecycle(tmp_path):
    require_integration_opt_in()
    require_steamcmd_opt_in()
    ...
    # create
    run_and_assert_ok(env, server_name, "create", "tfcserver")
    ...
    assert result.returncode == 0, (
        f"Unexpected tfcserver setup failure: rc={result.returncode}\n"
