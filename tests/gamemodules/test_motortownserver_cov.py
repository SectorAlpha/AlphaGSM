"""Full coverage tests for motortownserver."""
...
def test_install(tmp_path):
    server = DummyServer()
    server.data["dir"] = str(tmp_path) + "/"
    server.data["exe_name"] = "MotorTown/Binaries/Win64/MotorTownServer-Win64-Shipping.exe"
    server.data["Steam_AppID"] = 2223650
...
def test_get_start_command(tmp_path):
    ...
    server.data["dir"] = str(tmp_path) + "/"
    server.data["exe_name"] = "MotorTown/Binaries/Win64/MotorTownServer-Win64-Shipping.exe"
    exe_path = tmp_path / "MotorTown/Binaries/Win64/MotorTownServer-Win64-Shipping.exe"
