...
echo "Smoke test for theforestserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-ittheforests}"
SERVER_STARTED=0
...
sessiontag = AlphaGSM-theforests-IT#
keeplogs = 1
EOF
...
run_alphagsm "$SERVER_NAME" create theforestserver
