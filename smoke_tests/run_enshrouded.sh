...
echo "Smoke test for enshrouded is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
LOG_PATH="$HOME_DIR/logs/AlphaGSM-enshrouded-IT#$SERVER_NAME.log"
...
run_alphagsm "$SERVER_NAME" create enshrouded
