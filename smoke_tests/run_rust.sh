...
INSTALL_DIR="$WORK_DIR/rust-server"
CONFIG_PATH="$WORK_DIR/alphagsm-rust.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-rust-IT#$SERVER_NAME.log"
...
run_alphagsm "$SERVER_NAME" create rust
