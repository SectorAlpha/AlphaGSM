...
INSTALL_DIR="$WORK_DIR/ss14server-server"
CONFIG_PATH="$WORK_DIR/alphagsm-ss14server.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-ss14server-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-ss14server-IT#
keeplogs = 1
EOF
...
run_alphagsm "$SERVER_NAME" create ss14server
