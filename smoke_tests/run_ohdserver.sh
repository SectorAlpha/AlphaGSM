...
echo "Smoke test for ohdserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itohdserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/ohdserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-ohdserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-ohdserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-ohdserver-IT#
keeplogs = 1
EOF
...
run_alphagsm "$SERVER_NAME" create ohdserver
