...
SERVER_NAME="${SERVER_NAME:-itq3server}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/q3server-server"
CONFIG_PATH="$WORK_DIR/alphagsm-q3server.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-q3server-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-q3server-IT#
keeplogs = 1
EOF
...
run_alphagsm "$SERVER_NAME" create q3server
