...
SERVER_NAME="${SERVER_NAME:-itnecserver}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/necserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-necserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-necserver-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-necserver-IT#
keeplogs = 1
EOF
...
run_alphagsm "$SERVER_NAME" create necserver
