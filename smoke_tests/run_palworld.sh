...
SERVER_NAME="${SERVER_NAME:-itpalworld}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/palworld-server"
CONFIG_PATH="$WORK_DIR/alphagsm-palworld.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-palworld-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-palworld-IT#
keeplogs = 1
EOF
...
run_alphagsm "$SERVER_NAME" create palworld
