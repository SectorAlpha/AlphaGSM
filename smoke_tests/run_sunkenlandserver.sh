...
echo "Smoke test for sunkenlandserver is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itsunkenland}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/sunkenlandserver-server"
CONFIG_PATH="$WORK_DIR/alphagsm-sunkenlandserver.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-sunkenland-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-sunkenland-IT#
keeplogs = 1
EOF
...
run_alphagsm "$SERVER_NAME" create sunkenlandserver
