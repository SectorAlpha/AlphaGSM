...
echo "Smoke test for teamfortress2 is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itteamfortre}"
SERVER_STARTED=0
...
INSTALL_DIR="$WORK_DIR/teamfortress2-server"
CONFIG_PATH="$WORK_DIR/alphagsm-teamfortress2.conf"
LOG_PATH="$HOME_DIR/logs/AlphaGSM-teamfortre-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-teamfortre-IT#
keeplogs = 1
EOF
