...
echo "Smoke test for conanexiles is disabled - see docs/TEST_STATUS.md for status"
exit 0
...
SERVER_NAME="${SERVER_NAME:-itconanexile}"
SERVER_STARTED=0
...
LOG_PATH="$HOME_DIR/logs/AlphaGSM-conanexile-IT#$SERVER_NAME.log"
...
sessiontag = AlphaGSM-conanexile-IT#
keeplogs = 1
EOF
...
run_alphagsm "$SERVER_NAME" create conanexiles
